...
class CryptoData:
    ...
    def get_currencies(self):
        ...
        currencies = self._cg.get_coins_markets(vs_currency="usd")
        currencies_dict = {}
    ...
    def get_history(self, coin):
        return self._cg.get_coin_history_by_id(id=coin, date="30-12-2017")
    ...
    def get_coin_info(self, coin):
        ...
        info = self._cg.get_coin_by_id(coin)
    ...
    def get_coin_price(self, coin):
        ...
        price = self._cg.get_price(ids=coin, vs_currencies="usd")
